      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center">
          <div className="flex items-center gap-3 mr-8">
            <div className="w-14 h-14 bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 rounded-2xl flex items-center justify-center  hover:shadow-xl transition-all duration-300 hover:scale-105">
              <span className="text-white font-bold text-xl tracking-tight">E</span>
            </div>
            <div className="hidden md:block">
              <h1 className="text-xl font-semibold text-gray-800">Equityease</h1>
              <p className="text-sm text-gray-500">Investment Management</p>
            </div>
          </div>
          
          <nav className="bg-[#d0f1f8] backdrop-blur-lg  border-white/20 rounded-2xl  px-8 py-4 hover:shadow-xl transition-all duration-300">
