    ...
    <footer className="bg-[#005E89] text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
          {/* Address & Email */}
          <div className="md:col-span-2 text-[15px]">
            <div className="flex items-center mb-4">
              ...
              <span className="text-lg font-bold">Equityease</span>
            </div>
            <div className="space-y-1 mb-4">
              <p>Anand Asset Management, C-3 Haridaya,</p>
              <p>Subhash Rd, opposite Laxmi Cinema,</p>
              <p>Anand, Gujarat 388001.</p>
              <p className="mt-2">Contact us on <span className="font-semibold">help@equitycase.com</span></p>
              <p className="mt-2">Get market insights and facts right in your inbox</p>
            </div>
            <div className="flex w-40 h-8">
              <input
                type="email"
                placeholder="Email Address"
                className="flex-1 h-8 px-3 rounded-md bg-white text-gray-900 border-0 focus:ring-2 focus:ring-green-500 placeholder-gray-500"
              />
          ...
          {/* Find Us On Column */}
          <div className="text-[15px]  flex-col justify-between">
            <h3 className="text-base font-semibold mb-2">Find us on :</h3>
            <div className="flex space-x-3 mt-1">
              ...
              <a href="#" className="text-blue-100 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a2.994 2.994 0 00-2.112-2.112C19.633 3.5 12 3.5 12 3.5s-7.633 0-9.386.574a2.994 2.994 0 00-2.112 2.112C0 7.939 0 12 0 12s0 4.061.502 5.814a2.994 2.994 0 002.112 2.112C4.367 20.5 12 20.5 12 20.5s7.633 0 9.386-.574a2.994 2.994 0 002.112-2.112C24 16.061 24 12 24 12s0-4.061-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                </svg>
              </a>
            </div>
          </div>
